...
export const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Realiza una solicitud Inertia POST para el inicio de sesión
    Inertia.post('/login', credentials, {
      ...
      onError: (errors) => {
          ...
          alert(errors.email); // Puedes personalizar esto según tus necesidades
      },
  });
}
  ...
  return (
    ...
    <div className="container py-5 h-100">
      ...
      Login
              ...
              <div>
                <p className="mb-0">Ez duzu konturik? <a href="Signup" className="text-white-50 fw-bold">Sign Up</a>
                </p>
              </div>
