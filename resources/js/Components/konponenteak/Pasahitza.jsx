               ...
               <div className="container h-100">
                   <div className="row d-flex justify-content-center align-items-center h-75">
                       <div className="col col-xl-10">
                           ...
                           <form >
                <h5 className="fw-normal mb-3 pb-3" style={{ letterSpacing: '1px' }}>Pasahitz berreskurapena</h5>
                <div className="mb-4">
                    ...
                    <p className='mezua'>Zure email helbidea sartu eta gero konfirmazio bat bidaliko zaizu</p>
                </div>
