export const TarifakDark = () => {
    return (
        <div className='tarifak' style={{ backgroundColor: '#121212' }}>
        <h2 className="text-white">TARIFAK</h2>
        <div className="container text-center rounded-left">
            <div className="row row-cols-1 row-cols-sm-2 ">
                ...
                <p className="text-white">Beste produktuak ikusi</p>
                <p className="text-white">Produktuak erosi</p>
                <p className="text-white">Produktuak saldu</p>
                <p className="text-white">Iragarkiak </p>
                </div>
                <div className="produktuak-mota zoom border-white">
                ...
                <p className="text-white">Saltzeko produktuak promozionatu</p>
                <p className="text-white">Tasatutako produktuen estatistikak ikusi</p>
                <p className="text-white">Saldutako produktuen estatistikak ikusi</p>
                <p className="text-white">Erositako produktuen estatistikak ikusi  </p> 
                <p className="text-white">Orokorraren karakteristikak</p>             
                </div>
                <div className="produktuak-mota zoom text-white border-white">
