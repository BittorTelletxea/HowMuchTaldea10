    ...
    return (
        ...
        <div className="container text-center rounded-left">
            <div className="row row-cols-1 row-cols-sm-2 ">
                ...
                > Nahi dut! </button>
                <p className="text-center"><b>KARAKTERISTIKAK</b></p>  
                <p>Produktuak tasatu</p>               
                <p>Gehienez 10 produktu tasatu hilabetero</p>
                <p>Beste produktuak ikusi</p>
                <p>Produktuak erosi</p>
                <p>Produktuak saldu</p>
                <p>Iragarkiak </p>
                </div>
                <div className="produktuak-mota zoom">
                ...
                <p>Produktuak tasatu</p>
                <p>Gehienez 30 produktu tasatu hilabetero</p>
                <p>Beste produktuak ikusi</p>
                <p>Produktuak erosi</p>
                <p>Produktuak saldu</p>
                <p>Iragarkiak ez</p>
                <p>Saltzeko produktuak promozionatu</p>
                <p>Tasatutako produktuen estatistikak ikusi</p>
                <p>Saldutako produktuen estatistikak ikusi</p>
